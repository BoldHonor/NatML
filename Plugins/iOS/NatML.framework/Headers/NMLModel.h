...
/*!
 ...
 @param model
 Destination pointer to created model.
*/
BRIDGE EXPORT void APIENTRY NMLCreateModel (const char* modelPath, NMLModel** model);
...
*/
BRIDGE EXPORT void APIENTRY NMLModelGetMetadataKey (NMLModel* model, int32_t index, char* key);
...
*/
BRIDGE EXPORT void APIENTRY NMLModelGetMetadataValue (NMLModel* model, const char* key, char* value);
#pragma endregion
...
*/
BRIDGE EXPORT void APIENTRY NMLModelPredict (NMLModel* model, const NMLFeature * const * inputs, NMLFeature** outputs);
#pragma endregion
